...
class TNDM(ModelLoader, tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            behavioural_loglike_loss    = self.compiled_loss._losses[2](y,b)
            independence_loss           = self.compiled_loss._losses[3](g_r,g_i)
            ...
            loss =  self.loss_weights[0] * neural_loglike_loss + \
                    ...
                    self.loss_weights[2] * behavioural_loglike_loss + \
        ...
        core_logs = {
            ...
            'loss_behav': self.tracker_loss_behavioural_loglike.result() / self.tracker_loss_count.result(),
