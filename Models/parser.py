...
from Models.utils import AdaptiveWeights
...
class ModelType(Enum):
    ...
    def from_string(string: str) -> ModelType:
        ...
        elif string.lower() == 'nflvm':
            return ModelType.NFLVM
        elif string.lower() == 'snlvm':
            return ModelType.SNLVM
        else:
            raise ValueError('Value not recognized.')

    @property
    def with_behaviour(self) -> bool:
        return self.name.lower() == 'tndm' or self.name.lower() == 'snlvm'
